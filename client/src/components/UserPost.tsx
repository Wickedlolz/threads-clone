                ...
                <div className='flex-1 flex-col gap-2'>
                    <div className='flex justify-between w-full'>
                        <div className='flex w-full items-center gap-1'>
                            <p className='font-sm font-bold'>viktordimitrov</p>
                            <img
                        ...
                        <div className='flex items-center gap-3'>
                            <p className='font-sm text-gray-400'>1d</p>
                            <BsThreeDots />
                        </div>
                    </div>
                    <p className='font-sm'>This is my first post</p>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <p className='text-gray-500 font-sm'>200 likes</p>
                    </div>
                </div>
            </div>
        </Link>
